    ...
    return text
      ...
      .map((line, index) => {
        ...
        if (line.includes('┌─') || line.includes('├─') || line.includes('└─')) {
          return (
            <div key={index} className="font-mono text-sm bg-[#F5F5F7] dark:bg-gray-800 p-3 rounded-lg text-[#007AFF] dark:text-blue-400 leading-relaxed my-2 border-l-4 border-[#007AFF]">
              {line}
            </div>
          );
        }
